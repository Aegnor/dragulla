...
module.exports = {};
},{}],"js/assets/case.js":[function(require,module,exports) {
"use strict";

require("/img/*.jpg");
},{"/img/*.jpg":"../../../img/*.jpg"}],"../node_modules/gsap/gsap-core.js":[function(require,module,exports) {
"use strict";
...
},{"./gsap-core.js":"../node_modules/gsap/gsap-core.js","./CSSPlugin.js":"../node_modules/gsap/CSSPlugin.js"}],"js/utils/dom.js":[function(require,module,exports) {
"use strict";
...
var Drag = /*#__PURE__*/function () {
  ...
  _createClass(Drag, [{
    ...
    value: function onDragStart(event) {
      ...
      var x = (0, _dom.default)(event).x,
          y = (0, _dom.default)(event).y;
      this.drag.startX = x;
      this.drag.startY = y;

      _gsap.default.set(event.target, {
        zIndex: 43
      });
    }
  }, {
    ...
    value: function addEventListeners() {
      ...
      var elements = this.element;
      elements.forEach(function (element) {
        element.addEventListener('mousedown', _this2.onDragStart.bind(_this2));
        element.addEventListener('mousemove', _this2.onDragMove.bind(_this2));
        element.addEventListener('mouseup', _this2.onDragEnd.bind(_this2));
      });
...
},{"./assets/case":"js/assets/case.js","gsap":"../node_modules/gsap/index.js","./utils/dom":"js/utils/dom.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "10951" + '/');
